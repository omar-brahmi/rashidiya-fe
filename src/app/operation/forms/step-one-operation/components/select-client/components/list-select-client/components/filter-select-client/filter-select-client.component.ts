...
@Component({
  selector: 'app-filter-select-client',
  templateUrl: './filter-select-client.component.html',
  styleUrls: ['./filter-select-client.component.scss'],
})
export class FilterSelectClientComponent {
